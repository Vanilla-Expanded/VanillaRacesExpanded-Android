...
{
    [HotSwappable]
    public class Dialog_AndroidAwakenedChoices : Window
    {
        private ChoiceLetter_AndroidAwakened letter;
        ...
        public Dialog_AndroidAwakenedChoices(TaggedString text, ChoiceLetter_AndroidAwakened letter)
        {
            this.text = text;
            this.letter = letter;
            forcePause = true;
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            DrawTraitChoices(viewRect.width, ref oldY);
            curY = 400;
        ...
        private void DrawTraitChoices(float width, ref float curY)
        {
            ...
            {
                Widgets.Label(400, ref curY, width, "BirthdayPickTrait".Translate(letter.pawn).Resolve() + ":");
                Listing_Standard listing_Standard = new Listing_Standard();
                Rect rect = new Rect(400, curY, 230f, 99999f);
        ...
        {
            if ((!letter.passionChoices.NullOrEmpty() || !letter.traitChoices.NullOrEmpty()))
            {
                string text = "VREA.AndroidAwakenedChoices".Translate(letter.pawn.Named("PAWN"));
